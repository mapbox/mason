...
function mason_load_source {
    mason_download \
        ...
        7d45762397e695fc0156007034b9cc98adf91380
...
function mason_prepare_compile {
    ...
    ${MASON_DIR}/mason install protozero 1.6.8
    ${MASON_DIR}/mason link protozero 1.6.8
    ${MASON_DIR}/mason install rapidjson 2016-07-20-369de87
    ${MASON_DIR}/mason link rapidjson 2016-07-20-369de87
    ${MASON_DIR}/mason install libosmium 2.15.3
    ${MASON_DIR}/mason link libosmium 2.15.3
