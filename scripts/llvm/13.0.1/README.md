...
Before building LLVM 13.0.1, you need either:
...
1. Downloads LLVM 13.0.1 source
...
- `llvm/13.0.1` - Full LLVM toolchain
- `clang++/13.0.1` - C++ compiler
- `clang-format/13.0.1` - Code formatter
- `clang-tidy/13.0.1` - Static analyzer
- `llvm-cov/13.0.1` - Code coverage tool
