...
function mason_load_source {
    mason_download \
        ...
        c7ca8fe2bc4422e81c658e020ab5fe6e31de1977
...
function mason_prepare_compile {
    ...
    ${MASON_DIR}/mason install protozero 1.6.4
    ${MASON_DIR}/mason link protozero 1.6.4
    ${MASON_DIR}/mason install rapidjson 2016-07-20-369de87
    ${MASON_DIR}/mason link rapidjson 2016-07-20-369de87
    ${MASON_DIR}/mason install libosmium 2.15.0
    ${MASON_DIR}/mason link libosmium 2.15.0
