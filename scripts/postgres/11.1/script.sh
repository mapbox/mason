...
function mason_load_source {
    mason_download \
        ...
        5e9de6596922b8a9c65685be33c820a9c1a4f809
...
function mason_prepare_compile {
    ...
    ${MASON_DIR}/mason install readline ${READLINE_VERSION}
    MASON_READLINE=$(${MASON_DIR}/mason prefix readline ${READLINE_VERSION})
}
...
function mason_compile {
    ...
    export CFLAGS="-I${MASON_LIBEDIT}/include -I${MASON_NCURSES}/include -I${MASON_READLINE}/include ${CFLAGS}"
    export LDFLAGS="-L${MASON_LIBEDIT}/lib -L${MASON_READLINE}/lib -L${MASON_NCURSES}/lib ${LDFLAGS}"
    ./configure \
        --prefix=${MASON_PREFIX} \
        ${MASON_HOST_ARG} \
