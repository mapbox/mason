...
function mason_load_source {
    mason_download \
        ...
        5cc25924cd6f8bd566e9820ac208d214e525cfcf

    mason_extract_tar_gz

    export MASON_BUILD_PATH=${MASON_ROOT}/.build/${MASON_NAME}-1b254d2e5804d23f571deea2e4a4936cb2f9cee9
}
