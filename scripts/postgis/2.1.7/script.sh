...
function mason_load_source {
    mason_download \
        ...
        87da1df5e0dce6ce7df60441c22a860251443813
...
function mason_prepare_compile {
    ...
    ${MASON_DIR:-~/.mason}/mason install postgres 9.4.1
    MASON_POSTGRES=$(${MASON_DIR:-~/.mason}/mason prefix postgres 9.4.1)
    ...
    ${MASON_DIR:-~/.mason}/mason install gdal 1.11.2
    MASON_GDAL=$(${MASON_DIR:-~/.mason}/mason prefix gdal 1.11.2)
