...
function mason_load_source {
    mason_download \
        ...
        a87aee6d85b6e45803065c858e6c77746bfaa0ca
...
function mason_prepare_compile {
    ...
    ${MASON_DIR}/mason install protozero 1.7.0
    ${MASON_DIR}/mason link protozero 1.7.0
    ${MASON_DIR}/mason install rapidjson 2016-07-20-369de87
    ${MASON_DIR}/mason link rapidjson 2016-07-20-369de87
    ${MASON_DIR}/mason install libosmium 2.15.5
    ${MASON_DIR}/mason link libosmium 2.15.5
    ...
    ${MASON_DIR}/mason install expat 2.2.4
    ${MASON_DIR}/mason link expat 2.2.4
