...
Before building LLVM 17.0.6, you need either:
...
1. Downloads LLVM 17.0.6 source
...
- `llvm/17.0.6` - Full LLVM toolchain
- `clang++/17.0.6` - C++ compiler
- `clang-format/17.0.6` - Code formatter
- `clang-tidy/17.0.6` - Static analyzer
- `llvm-cov/17.0.6` - Code coverage tool
