...
```sh
mkdir ./mason
curl -sSfL https://github.com/mapbox/mason/archive/v0.11.1.tar.gz | tar --gunzip --extract --strip-components=1 --exclude="*md" --exclude="test*" --directory=./mason
```
...
```sh
curl -sSfL https://github.com/mapbox/mason/archive/v0.11.1.tar.gz | tar --gunzip --extract --strip-components=1 --exclude="*md" --exclude="test*" --directory=/tmp
```
