...
Before building LLVM 16.0.6, you need either:
...
1. Downloads LLVM 16.0.6 source
...
- `llvm/16.0.6` - Full LLVM toolchain
- `clang++/16.0.6` - C++ compiler
- `clang-format/16.0.6` - Code formatter
- `clang-tidy/16.0.6` - Static analyzer
- `llvm-cov/16.0.6` - Code coverage tool
