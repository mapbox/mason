...
function mason_load_source {
    mason_download \
        https://github.com/mapbox/tippecanoe/tarball/1.15.1 \
        1ff0482c1b60b9204d5748d911a6a8aa419b390e

    mason_extract_tar_gz

    export MASON_BUILD_PATH=${MASON_ROOT}/.build/mapbox-tippecanoe-c68d553
}
