...
MASON_NAME=libedit
MASON_VERSION=20150325-3.1
MASON_LIB_FILE=lib/libedit.a
MASON_PKGCONFIG_FILE=lib/pkgconfig/libedit.pc
...
function mason_load_source {
    mason_download \
        https://ftp.netbsd.org/pub/pkgsrc/distfiles/libedit-${MASON_VERSION}.tar.gz \
        fa017ec996f15b797458526f70be9d9a98926e53

    mason_extract_tar_gz

    export MASON_BUILD_PATH=${MASON_ROOT}/.build/libedit-${MASON_VERSION}
}
