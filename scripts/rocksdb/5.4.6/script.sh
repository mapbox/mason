...
function mason_load_source {
    mason_download \
        https://github.com/facebook/rocksdb/archive/rocksdb-5.6.1.tar.gz \
        35867229b6dcb8e1730da0b72fe76b9633709ca2

    mason_extract_tar_gz

    export MASON_BUILD_PATH=${MASON_ROOT}/.build/${MASON_NAME}-5.6.1
}
